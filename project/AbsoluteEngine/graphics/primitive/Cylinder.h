...
public:
    ...
    struct Params {
        ...
        bool flipV = true; // UVのV方向反転
        bool uvVertical = true; // 追加：縦方向の柱にするためのフラグ
        Vector4 colorTop = { 1.0f, 1.0f, 1.0f, 1.0f };
        Vector4 colorBottom = { 1.0f, 1.0f, 1.0f, 1.0f };
        float alphaReference = 0.0f; // discardのしきい値
    };
